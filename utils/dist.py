...
If you want to reduce on CPU instead (required for big datasets like GQA), use the env variable RDETR_CPU_REDUCE=1
"""
import functools
import io
import os
...
def all_gather(data):
    ...
    cpu_group = None
    if os.getenv("RDETR_CPU_REDUCE") == "1":
...
def init_distributed_mode(args):
    ...
    print(f"GPU {args.gpu} : {torch.cuda.is_available()}")
