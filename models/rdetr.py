...
class RDETR(nn.Module):
    """ This is the RDETR module that performs modulated object detection """
    ...
    def __init__(
        ...
        Args:
            ...
            num_queries: number of object queries, ie detection slot. This is the maximal number of objects
                         RDETR can detect in a single image. For COCO, we recommend 100 queries.
    ...
    def forward(self, samples: NestedTensor, captions, encode_and_save=True, memory_cache=None, combine_encode=False):
...
class SetCriterion(nn.Module):
    ...
    def loss_isfinal(self, outputs, targets, positive_map, indices, num_boxes):
        ...
        Eg if the caption is "the cube next to the cylinder", RDETR will detect both the cube and the cylinder.
